...
<head>
    ...
    <link rel="stylesheet" href="css/header volunteer.css">
        ...
        <div class="head-container">
            ...
            <div class="navigation">
                <ul>
                    ...
                    <a href="./organizeEvents.php">
                        <li><div class="logger">Organize Events</div></li>
                    </a>
                    <a href="./fund donate.php">
                        <li><div class="logger">Donate Funds</div></li>
                    </a>
                    <a href="news volunteer.php">
                        <li><div class="logger">News & Events</div></li>
                    </a>
                    <a href="./contact us volunteer.php">
                        <li><div class="logger">Contact Us</div></li>
                    </a>
                    <a href="./about us volunteer.php">
            ...
            <div class="profile">
                <a style="text-decoration: none; color: rgb(214, 3, 3);" href="./user profile volunteer.php">Volunteer<br>Profile
